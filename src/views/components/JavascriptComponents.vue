        ...
        <div class="col-lg-5">
          ...
          <tabs
            ...
            <tab-pane>
              <span
                slot="title"
                class="nav-link-icon d-block"><i class="ni ni-atom"/></span>
            </tab-pane>
            <tab-pane>
              <span
                slot="title"
                class="nav-link-icon d-block"><i class="ni ni-chat-round"/></span>
            </tab-pane>
            <tab-pane>
              <span
                slot="title"
                class="nav-link-icon d-block"><i
                  class="ni ni-cloud-download-95"/></span>
            </tab-pane>
          </tabs>
        </div>
        <div class="col-lg-5">
          ...
          <badge
            type="primary"
            class="text-uppercase">Primary</badge>
          <badge
            type="success"
            class="text-uppercase">Success</badge>
          <badge
            type="danger"
            class="text-uppercase">Danger</badge>
          <badge
            type="warning"
            class="text-uppercase">Warning</badge>
          <badge
            type="info"
            class="text-uppercase">Info</badge>
        </div>
      </div>
      <h3 class="mt-lg mb-4">
        <span>Alerts</span>
